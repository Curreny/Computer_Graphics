...
function handleKeyDown(event) {
    ...
    if (changePos === 2) {
        switch (key) {
            ...
            case 81: // q//x scale-
                csx -= 0.1;
                document.getElementById("xscale").value = csx;
                break;
            case 69: // e//x scale+
                csx += 0.1;
                document.getElementById("xscale").value = csx;
            ...
            case 82: // r//y scale+
                csy += 0.1;
                document.getElementById("yscale").value = csy;
                break;
            case 70: // f//y scale-
                csy -= 0.1;
                document.getElementById("yscale").value = csy;
            ...
            case 84: // t//z scale+
                csz += 0.1;
                document.getElementById("zscale").value = csz;
                break;
            case 71: // g//z scale-
                csz -= 0.1;
                document.getElementById("zscale").value = csz;
...
function buildModelViewProj() {
    ...
    if (changePos === 1) {
        ...
        mat4.scale(mvMatrix, mvMatrix, vec3.fromValues(csx, csy, csz));
    }
