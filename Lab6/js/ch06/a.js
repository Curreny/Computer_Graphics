...
function initSphere() {
    ...
    // 设置滑杆事件监听器
    document.getElementById("subdivideSlider").addEventListener("input", function (event) {
        updateSubdivision(event.target.value);
    });
...
function updateSubdivision(value) {
    numOfSubdivides = parseInt(value);
    document.getElementById("subdivideValue").innerText = numOfSubdivides;
